...
public class xpath {
    public static void main(String[] args) {
        ...
        //access the phone number and send in the number
        WebElement phoneNumb = driver.findElement(By.cssSelector("input#user_phone"));
        phoneNumb.sendKeys("+3474885919");

        //access the webElement adresss ans send in the address
        WebElement address = driver.findElement(By.cssSelector("input[id*='attributes_street']"));
        address.sendKeys("107160s avenue ");
